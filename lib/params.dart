...
// - η = 2
//
// The following constants define the sizes (in bytes) for keys, ciphertext, polynomials, etc.
...
/// A compressed polynomial is represented in 96 bytes when compressing each coefficient
/// to 3 bits (256 coefficients × 3 bits = 768 bits; 768 / 8 = 96 bytes).
const int KYBER_POLYCOMPRESSEDBYTES = 96;
...
/// Compression bit-lengths used in the encoding of u and v in the ciphertext.
...
const int KYBER_DU = 12; // Full encoding: 12 bits per coefficient.
const int KYBER_DV = 3;  // Compressed representation: 3 bits per coefficient.

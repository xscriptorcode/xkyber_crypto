...
String encodeCoefficients(List<int> coefficients) {
  ...
  for (int coeff in coefficients) {
    // Especifica el tipo int para cada coeficiente
...
List<int> decodeCoefficients(String base64Str) {
  final Uint8List bytes =
      base64Decode(base64Str); // Especifica Uint8List para bytes
  if (bytes.length % 2 != 0) {
    throw FormatException(
        "Longitud de bytes inválida para decodificar coeficientes.");
  }
